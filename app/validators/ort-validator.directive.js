System.register(['angular2/core', 'angular2/common', './ort-validator'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, ort_validator_1;
        ...
        execute: function() {
            OrtValidatorDirective = (function () {
                ...
                OrtValidatorDirective = __decorate([
                    core_1.Directive({
                        selector: 'input[ort]',
                        providers: [core_1.provide(common_1.NG_VALIDATORS, { useValue: ort_validator_1.OrtValidator.validate, multi: true })]
                    }), 
